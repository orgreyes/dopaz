...
class AsigRequisito extends ActiveRecord{
    ...
    protected static $columnasDB = ['asig_req_puesto','asig_req_requisito','asig_req_aprovada','asig_req_situacion'];
    protected static $idTabla = 'asig_req_id';

    public $asig_req_id;
    public $asig_req_puesto;
    public $asig_req_requisito;
    public $asig_req_aprovada;
    ...
    public function __construct($args = [])
    {
        ...
        $this->asig_req_aprovada = $args['asig_req_aprovada'] ?? '1';
