...
class AsigPapeleria extends ActiveRecord{
    ...
    protected static $columnasDB = ['asig_pap_puesto','asig_pap_papeleria','asig_pap_situacion'];
    protected static $idTabla = 'asig_pap_id';

    public $asig_pap_id;
    public $asig_pap_puesto;
    public $asig_pap_papeleria;
    ...
    public function __construct($args = [])
    {
        ...
        $this->asig_pap_papeleria = $args['asig_pap_papeleria'] ?? '';
