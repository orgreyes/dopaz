...
<div class="container">
  ...
  <div id="tablaAspirantesContainer" class="container mt-1">
    <div class="row justify-content-center mt-4">
      <div class="col-12 p-4 shadow">
        <div class="text-center">
          <h1>Lista de Aspirantes a Contingente</h1>
        </div>
        <table id="tablaAspirantes" class="table table-bordered table-hover">
