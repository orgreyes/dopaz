...
<div class="container">
  <div class="row justify-content-center">
    <form class="col-lg-8 border bg-light p-3">
      <h1 class="text-center">Asignacion de Evaluaciones por Puesto</h1><br>
      <input type="hidden" name="asig_eva_id" id="asig_eva_id">

      <!--//!Nombre del Puesto -->
      <div class="row mb-3 col-md-12">
          <div class="col">
              <label for="asig_eva_puesto"><i  class="fas fa-globe"></i> Seleccione Un Puesto </label><br>
              <select name="asig_eva_puesto" id="asig_eva_puesto" style="width: 100%; border: 1px solid #ccc; padding: 5px; border-radius: 5px;">
      ...
      <div class="row mb-3 col-md-12">
          <div class="col">
              <label for="asig_eva_nombre"><i class="fas fa-flag"></i> Seleccione la Evaluacion que Desea Asignar al Puesto Seleccionado</label><br>
              <select name="asig_eva_nombre" id="asig_eva_nombre" style="width: 100%; border: 1px solid #ccc; padding: 5px; border-radius: 5px;">
                  <option value="">SELECCIONE...</option>
                  <?php foreach ($evaluaciones as $evaluacion) : ?>
                  <option value="<?= $evaluacion['eva_id'] ?>">
    ...
    <div style="margin-top:30px; margin-left:32%" class="row mb-3">
      <div class="col-8">
        <button type="button" id="btnFormulario" class="btn btn-info w-100">Agregar Evaluacion</button>
      </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header ">
                <h5 class="modal-title " id="modalRequisitoLabel">Evaluaciones Para este Puesto</h5>
...
<script src="<?= asset('./build/js/asigevaluaciones/index.js') ?>"></script>
</body>
</html>
