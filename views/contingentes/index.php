  ...
  <div class="row justify-content-center">
            ...
            <!-- //!Fecha de Inicio -->
                ...
                <div class="col-8 mx-auto" style="margin-to:10px">
                    ...
                    <div class="col-6">
                        <button type="button" id="btnCancelar" class="btn bi bi-x custom-btn custom-btn-danger w-100">Cancelar</button>
                    </div>
                </div>
            </form>
            ...
            <div style="margin-top:30px; margin-left:32%" class="row mb-3">
                    <div class="col-8">
                        <button type="button" id="btnFormulario" class="btn custom-btn bi bi-save btn-primary w-100">  Agregar Contingente</button>
                    </div>
                    <div style="margin-top:8px;" class="col-8">
                        <button type="button" id="btnBuscar" class="btn custom-btn bi bi-eye btn-primary w-100">  Ver Lista de Contingentes</button>
                    </div>
                </div>
