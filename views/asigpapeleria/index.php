...
<div class="container">
  <div class="row justify-content-center">
    <form class="col-lg-8 border bg-light p-3">
      <h1 class="text-center">Asignacion de Documentos por Puesto</h1><br>
      ...
      <div class="row mb-3 col-md-12">
          <div class="col">
              <label for="asig_pap_nombre"><i class="fas fa-flag"></i> Seleccione el Documento que Desea Asignar al Puesto Seleccionado</label><br>
              <select name="asig_pap_nombre" id="asig_pap_nombre" style="width: 100%; border: 1px solid #ccc; padding: 5px; border-radius: 5px;">
                  <option value="">SELECCIONE...</option>
    ...
    <div style="margin-top:30px; margin-left:32%" class="row mb-3">
      <div class="col-8">
        <button type="button" id="btnFormulario" class="btn btn-info w-100">Agregar Documento</button>
      </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header ">
                <h5 class="modal-title " id="modalRequisitoLabel">Documentos Necesarios Para este Puesto</h5>
...
<script src="<?= asset('./build/js/asigpapeleria/index.js') ?>"></script>
</body>
</html>
